  ...
  return (
    <section id="sobre-mi" className="snap-start py-20 px-6 max-w-4xl mx-auto text-center">
      ...
      <p className="text-gray-400 text-lg leading-relaxed">
        ...
        Tengo más de 2 años de experiencia trabajando con tecnologías como <strong className="text-white">Nuxt.js, React, TypeScript</strong> y soluciones backend como <strong className="text-white">Node.js, Firebase y PostgreSQL</strong>.
      </p>
